Program to take a bank CSV and generate a spending total of all the values in said CSV where the description value matches one of those passed in to the program.
